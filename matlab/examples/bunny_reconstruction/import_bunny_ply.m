function bun000 = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   BUN000 = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   BUN000 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   bun000 = importfile('bun000.ply', 25, 245080);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2014/08/14 13:09:45
